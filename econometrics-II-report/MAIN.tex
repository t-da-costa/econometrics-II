...
\logo
\marginmark
\header{Econometrics II}{Master 2 EEET}\\     % Matière et n° du TP

\begin{flushright}
\titre{{\strut \huge \bfseries \sffamily  \hspace*{9 cm}Changes in electricity demand to 2030}}\\ [0.15cm]                              % Titre du TP
\end{flushright}
% \vspace{-0.3cm}
...
\resume{\input{./resume.tex}}\vspace{0.1cm}            % Voir le fichier "resume.tex"
\keywords{\rm Econometrics, Ordinary Least Square, Forecasting.}\vspace{0.15cm} \\           % Mots clefs
\end{@twocolumnfalse}}]
...
\newcommand{\headeri}{Econometrics II}              % Header interne
...
% \input{./0introduction.tex} %écrire de dans le fichier "introduction.tex"
\input{./1theorie.tex}
% \input{./2Methodes.tex}
% \input{./3Resultats.tex}
% \input{./3zprototype.tex}%etc...
